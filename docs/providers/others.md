...
| **sipgate** (DE) | German consumer/business ITSP with attractive pricing and easy German KYC — but no CH/PL/HK/US DIDs; trunk features are registration-based and consumer-shaped | A dedicated *German-only* number project where consumer-grade KYC wins; could complement the main trunk |
