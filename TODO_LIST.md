...
| Task                                                                                                                              | Status    | Impact | Effort | Evidence                                                                                                      |
| --------------------------------------------------------------------------------------------------------------------------------- | --------- | ------ | ------ | -------------------------------------------------------------------------------------------------------------- |
| Webphone auto-reconnect can hang: sip.js 0.21 `userAgent.reconnect()` never settles after a transport loss (pill stuck at try-N backoff; reload recovers) — reproduce via the browser suite's reconnect drill, fix or upgrade SIP.js | 🔴 `TODO` | High | 2h | Found by the new reconnect drill (2026-08-27): `RECONNECT-AUTO-STUCK` marker; recovery-via-reload is asserted as the workaround |
